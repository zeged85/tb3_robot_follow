...
if("TRUE" STREQUAL "TRUE")
  set(armadillo2_sim_interface_SOURCE_PREFIX /home/zeged/catkin_ws/src/armadillo2/armadillo2_sim_interface)
  set(armadillo2_sim_interface_DEVEL_PREFIX /home/zeged/catkin_ws/devel)
  ...
  set(armadillo2_sim_interface_INSTALL_PREFIX /home/zeged/catkin_ws/install)
...
if(NOT "/home/zeged/catkin_ws/src/armadillo2/armadillo2_sim_interface/include " STREQUAL " ")
  set(armadillo2_sim_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/zeged/catkin_ws/src/armadillo2/armadillo2_sim_interface/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'armadillo2_sim_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zeged/catkin_ws/src/armadillo2/armadillo2_sim_interface/${idir}'.  ${_report}")
    endif()
