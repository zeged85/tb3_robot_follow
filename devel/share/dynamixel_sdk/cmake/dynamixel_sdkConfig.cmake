...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_sdk_SOURCE_PREFIX /home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/dynamixel_sdk)
  set(dynamixel_sdk_DEVEL_PREFIX /home/zeged/catkin_ws/devel)
  ...
  set(dynamixel_sdk_INSTALL_PREFIX /home/zeged/catkin_ws/install)
...
if(NOT "/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/dynamixel_sdk/include " STREQUAL " ")
  set(dynamixel_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/dynamixel_sdk/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/dynamixel_sdk/${idir}'.  ${_report}")
    endif()
