...
if(NOT "/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/bms_interface/include " STREQUAL " ")
  set(bms_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/bms_interface/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bms_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zeged/catkin_ws/src/armadillo2/armadillo2_utils/bms_interface/${idir}'.  ${_report}")
    endif()
