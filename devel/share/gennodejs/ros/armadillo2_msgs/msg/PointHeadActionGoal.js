...
class PointHeadActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PointHeadGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PointHeadGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PointHeadActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PointHeadGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PointHeadGoal()
    }
