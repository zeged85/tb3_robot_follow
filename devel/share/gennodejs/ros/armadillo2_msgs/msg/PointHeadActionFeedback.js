...
class PointHeadActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PointHeadFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PointHeadActionFeedback(null);
    ...
    data.feedback = PointHeadFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PointHeadActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PointHeadFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PointHeadFeedback()
    }
...
module.exports = PointHeadActionFeedback;
