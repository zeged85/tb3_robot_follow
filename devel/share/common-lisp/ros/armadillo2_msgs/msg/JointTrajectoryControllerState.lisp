...
(cl:defmethod cl:initialize-instance :after ((m <JointTrajectoryControllerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTrajectoryControllerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name armadillo2_msgs-msg:<JointTrajectoryControllerState> is deprecated: use armadillo2_msgs-msg:JointTrajectoryControllerState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:header-val is deprecated.  Use armadillo2_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'joint_names-val :lambda-list '(m))
(cl:defmethod joint_names-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:joint_names-val is deprecated.  Use armadillo2_msgs-msg:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:desired-val is deprecated.  Use armadillo2_msgs-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual-val :lambda-list '(m))
(cl:defmethod actual-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:actual-val is deprecated.  Use armadillo2_msgs-msg:actual instead.")
  (actual m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:error-val is deprecated.  Use armadillo2_msgs-msg:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTrajectoryControllerState>)))
  ...
  "armadillo2_msgs/JointTrajectoryControllerState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTrajectoryControllerState)))
  "Returns string type for a message object of type 'JointTrajectoryControllerState"
  "armadillo2_msgs/JointTrajectoryControllerState")
