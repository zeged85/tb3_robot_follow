...
(cl:defclass <PointHeadGoal> (roslisp-msg-protocol:ros-message)
  ((target
    :reader target
    :initarg :target
...
(cl:defclass PointHeadGoal (<PointHeadGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PointHeadGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PointHeadGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name armadillo2_msgs-msg:<PointHeadGoal> is deprecated: use armadillo2_msgs-msg:PointHeadGoal instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:target-val is deprecated.  Use armadillo2_msgs-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'pointing_axis-val :lambda-list '(m))
(cl:defmethod pointing_axis-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:pointing_axis-val is deprecated.  Use armadillo2_msgs-msg:pointing_axis instead.")
  (pointing_axis m))

(cl:ensure-generic-function 'pointing_frame-val :lambda-list '(m))
(cl:defmethod pointing_frame-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:pointing_frame-val is deprecated.  Use armadillo2_msgs-msg:pointing_frame instead.")
  (pointing_frame m))

(cl:ensure-generic-function 'min_duration-val :lambda-list '(m))
(cl:defmethod min_duration-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:min_duration-val is deprecated.  Use armadillo2_msgs-msg:min_duration instead.")
  (min_duration m))

(cl:ensure-generic-function 'max_velocity-val :lambda-list '(m))
(cl:defmethod max_velocity-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader armadillo2_msgs-msg:max_velocity-val is deprecated.  Use armadillo2_msgs-msg:max_velocity instead.")
  (max_velocity m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PointHeadGoal>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointHeadGoal>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PointHeadGoal>)))
  "Returns string type for a message object of type '<PointHeadGoal>"
  "armadillo2_msgs/PointHeadGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PointHeadGoal)))
  "Returns string type for a message object of type 'PointHeadGoal"
  "armadillo2_msgs/PointHeadGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PointHeadGoal>)))
  "Returns md5sum for a message object of type '<PointHeadGoal>"
  "8b92b1cd5e06c8a94c917dc3209a4c1d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PointHeadGoal)))
  "Returns md5sum for a message object of type 'PointHeadGoal"
  "8b92b1cd5e06c8a94c917dc3209a4c1d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointHeadGoal>)))
  "Returns full string definition for message of type '<PointHeadGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointHeadGoal)))
  "Returns full string definition for message of type 'PointHeadGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%geometry_msgs/PointStamped target~%geometry_msgs/Vector3 pointing_axis~%string pointing_frame~%duration min_duration~%float64 max_velocity~%~%================================================================================~%MSG: geometry_msgs/PointStamped~%# This represents a Point with reference coordinate frame and timestamp~%Header header~%Point point~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <PointHeadGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PointHeadGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'PointHeadGoal
