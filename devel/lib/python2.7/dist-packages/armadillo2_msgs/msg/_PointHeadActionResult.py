...
"""autogenerated by genpy from armadillo2_msgs/PointHeadActionResult.msg. Do not edit."""
import sys
...
class PointHeadActionResult(genpy.Message):
  ...
  _type = "armadillo2_msgs/PointHeadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','armadillo2_msgs/PointHeadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = armadillo2_msgs.msg.PointHeadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = armadillo2_msgs.msg.PointHeadResult()
